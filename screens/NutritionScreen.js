...
const NutritionScreen = ({ navigation }) => {
  const { nutrition, updateWaterIntake, resetWaterIntake } = useContext(UserDataContext)
      ...
      <View style={styles.waterContainer}>
        ...
        <View style={styles.waterTracker}>
          {Array.from({ length: 8 }).map((_, index) => (
            <View key={index} style={[styles.waterCup, index < nutrition.waterIntake && styles.waterCupFilled]}>
              <Ionicons name="water" size={30} color={index < nutrition.waterIntake ? "#fff" : "#ccc"} />
            </View>
          ))}
        </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text style={[styles.tabButtonText, activeTab === "plans" && styles.activeTabButtonText]}>Meal Plans</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={[styles.tabButtonText, activeTab === "water" && styles.activeTabButtonText]}>Water</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={[styles.tabButtonText, activeTab === "calories" && styles.activeTabButtonText]}>Calories</Text>
        </TouchableOpacity>
      </View>
