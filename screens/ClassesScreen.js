            ...
            >
              <View style={styles.classCardHeader}>
                <View style={styles.classTime}>
                  ...
                  <Text style={styles.durationText}>{classItem.duration} min</Text>
                </View>
              ...
              <View style={styles.classCardBody}>
                ...
                <View style={styles.classCapacity}>
                  ...
                  <View style={styles.capacityBarContainer}>
                    <View
                      style={[styles.capacityBar, { width: `${(classItem.enrolled / classItem.capacity) * 100}%` }]}
                    />
                  </View>
                </View>
              </View>
              ...
              <View style={styles.classCardFooter}>
                {classItem.isBooked ? (
                  <TouchableOpacity style={styles.cancelButton} onPress={() => handleCancelClass(classItem.id)}>
                    <Text style={styles.cancelButtonText}>Cancel</Text>
                  </TouchableOpacity>
                ) : (
                  <TouchableOpacity
                    style={[styles.bookButton, classItem.enrolled >= classItem.capacity && styles.disabledButton]}
                ...
                {classItem.enrolled >= classItem.capacity && !classItem.isBooked && (
